...
cameras_omineca_unique <-  cameras_omineca %>% distinct(WID_12km, .keep_all = TRUE)
DNA_omineca <- st_intersection(omineca, DNA_grid) # reducing smapling sites to grid cell of 12km
DNA_omineca_unique <-  DNA_omineca %>% distinct(WID_12km, .keep_all = TRUE) # reducing smapling sites to grid cell of 12km
...
#J.s <- 25
J.s<-49 # placing 4092 hair traps on a 49 grids of 12km

#J.o <- 50
J.o<-49 # placing 1121 camera traps on 49 grids of 12km 
